...
consumer = KafkaConsumer('ClientSessions_Vendor',bootstrap_servers=['0.0.0.0:9092'],value_deserializer=lambda v: json.loads(v).decode('utf-8'))
if (path.exists("ClientSessions_vendor.csv")) == False:
    f = open("ClientSessions_vendor.csv","a")
