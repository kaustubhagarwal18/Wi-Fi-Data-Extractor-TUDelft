...
consumer = KafkaConsumer('ClientStats_Day',bootstrap_servers=['0.0.0.0:9092'],value_deserializer=lambda v: json.loads(v).decode('utf-8'))
if (path.exists("ClientStats_day.csv")) == False:
    f = open("ClientStats_day.csv","a")
